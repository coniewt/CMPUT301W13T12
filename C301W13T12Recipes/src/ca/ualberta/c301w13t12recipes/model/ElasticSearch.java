...
*/
		...
		/*public void searchRecipes(String str) throws ClientProtocolException, IOException {
			...
			Type elasticSearchSearchResponseType = new TypeToken<ElasticSearchResponse<Recipe>>(){}.getType();
			ElasticSearchResponse<Recipe> esResponse = gson.fromJson(json, elasticSearchSearchResponseType);
